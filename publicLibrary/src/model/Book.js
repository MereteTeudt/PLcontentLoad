...
Book.createTestData = function() 
{
    ...
    let testOne = {isbn:"006251587X", title:"Weaving the Web", year:2000};
    let testTwo = {isbn:"0465026567", title:"Gödel, Escher, Bach", year:1999};
    let testThree = {isbn:"0465030793", title:"I Am A Strange Loop", year:2008};
    
    Book.instances[testOne.isbn] = new Book(testOne);
    Book.instances[testTwo.isbn] = new Book(testTwo);
    Book.instances[testThree.isbn] = new Book(testThree);
